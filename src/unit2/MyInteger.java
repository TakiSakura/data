...
public class MyInteger implements Comparable<MyInteger>//整数类，最终类，实现可比较接口
{
    ...
    //（2） 将整数字符串转换为整数
    //将串s按十进制转换为整数。
    //特别说明：本方法与java.lang.Integer类中的同名方法功能相同。
    ...
    public static int parseInt(String s, int radix) throws NumberFormatException
    {
        ...
        while(i<s.length())                      //获得无符号的整数绝对值
        {
            ...
            if(ch>='0' && ch-'0'<radix)          //当2≤radix≤10时，radix进制要识别0～radix-1数字
                ...
                //当11≤radix≤16时，radix进制还要识别从'a'/'A'开始的radix-10个字母表示的整数值
...
//@author：Yeheya。2014年10月3日，2015-2-28，2019年9月28日